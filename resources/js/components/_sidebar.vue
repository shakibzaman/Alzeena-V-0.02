<template>
  <v-list dense>
    <v-list-tile exact to="/admin/dashboard">
      <v-list-tile-action>
    ...
    <v-list-tile to="/admin/online-pos">
      ...
      <v-list-group no-action>
          ...
          <v-list-tile to="/admin/addSupProduct">
              <v-list-tile-action>
                  <v-icon>text_snippet</v-icon>
              </v-list-tile-action>
              <v-list-tile-content>
                  <v-list-tile-title>Supplier Order</v-list-tile-title>
              </v-list-tile-content>
          </v-list-tile>
      </v-list-group>
      <v-list-group no-action>
    ...
    <v-list-tile to="/admin/products-barcode">
              <v-list-tile-action>
                  <v-icon>calendar_view_day</v-icon>
              </v-list-tile-action>
              <v-list-tile-content>
                  <v-list-tile-title>Products Barcode</v-list-tile-title>
              </v-list-tile-content>
          </v-list-tile>
      ...
      <v-list-group no-action>
          ...
          <v-list-tile to="/admin/reportorder-products">
              ...
              <v-list-tile-content>
                  <v-list-tile-title>Products 1</v-list-tile-title>
              </v-list-tile-content>
          </v-list-tile>
          <v-list-tile to="/admin/products-barcode">
              <v-list-tile-action>
