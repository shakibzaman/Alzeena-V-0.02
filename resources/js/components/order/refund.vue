                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                ...
                                <tr v-for="detail in details">
                                    ...
                                    <td>
                                        <router-link :to="{name: 'refundOption', params:{id: detail.id} }" class="btn btn-sm btn-info">Refund</router-link>
                                        <a @click="refundProduct(detail.id)" class="btn btn-sm btn-danger">Refund</a>
                                    </td>
                                </tr>
