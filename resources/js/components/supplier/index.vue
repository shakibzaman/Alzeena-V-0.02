    ...
    <div>
       ...
       <div class="row card container">
          <div class="card-header">
            ...
            Supplier Insert
            <router-link :to="{name:'store-supplier'}" class="btn btn-sm btn-info" id="add_new"> Add New</router-link>
          </div>
          <div class="card-body">
            <div class="card-body">
...
<!--                        <router-link :to="{name: 'edit-supplier', params:{id: supplier.id} }" class="btn btn-sm btn-info">Edit</router-link>-->
                        <router-link :to="{name: 'detailssupplier', params:{id: supplier.id} }" class="btn btn-sm btn-info">Accounts</router-link>
