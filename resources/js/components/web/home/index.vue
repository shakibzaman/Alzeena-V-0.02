...
text/x-generic index.vue ( exported SGML document, ASCII text, with very long lines )
<template>
<div>
   <!-- Hero Section Begin -->
    <div class="hero">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item slider-image" :style="{'background-image':'url(https://www.alzeena.com.bd/web/img/slider.jpg)'}">
                    ...
                    <div v-for="feature in features" :key="feature.id" class="col-md-3">
                        ...
                        <div class="product__item__pic set-bg" >
                            ...
                            <ul class="product__item__pic__hover">
                                <li><router-link :to="{name: 'productShow',params:{id: feature.id}}"><i class="fa fa-retweet"></i></router-link></li>
                                <button class="btn bt-sm" @click.prevent="AddToCart(feature.id)"><li><i class="fa fa-shopping-cart"></i></li></button>
                            </ul>
                        </div>
                        <div class="product__item__text">
                            <h6><a href="#">{{feature.product_name}}</a></h6>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="banner__pic">
                        <img src="https://www.alzeena.com.bd/web/img/banner/banner-1.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="banner__pic">
                        <img src="https://www.alzeena.com.bd/web/img/banner/banner-2.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        created() {
         this.getResults();
            ...
            axios.get('/apipublic/public-online-product/')
                ...
                .catch()
            axios.get('/apipublic/feature-list/')
