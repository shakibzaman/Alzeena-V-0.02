...
let productBarcode = require('./components/product/barcode.vue').default;
let editproduct = require('./components/product/edit.vue').default;
let feature = require('./components/product/feature.vue').default;
//store products
...
// logo 
let logo  = require('./components/general/logo.vue').default;
...
export const routes = [
    ...
    // General 
    { path: '/admin/logo', component: logo , name:'logo' },
    // end general 
    ...
    { path: '/admin/products-barcode', component: productBarcode, name:'productBarcode' },
    { path: '/admin/feature', component: feature, name:'feature' },
