...
Route::apiResource('/general', 'PublicApi\GeneralController');
...
Route::get('/feature-list/', 'AdminApi\ProductController@featureList');
// Route::get('/category-product-list/', 'PublicApi\OnlineProductController@categoryProductList');
